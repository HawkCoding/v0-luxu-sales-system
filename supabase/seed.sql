...
insert into public.suppliers (id,kind,name,email,phone,website,notes,active,created_at,updated_at,status,location,slug,location_id,single_supplement_pct,street_address,description,default_time_start,default_time_end,location_area_id,infant_max_age,child_max_age,inclusions,exclusions) values
...
CHECK-IN/OUT:
Check-in at 15h00
Check-out at 12h00',true,'2026-07-01T07:26:47.837801+00:00','2026-07-01T08:04:37.205593+00:00','active',null,'taj-hotel','00000000-0000-0000-0000-000000001002',0,'1 Wale Street corner Saint Georges Mall, Wale St, Cape Town City Centre, Cape Town, 8000','This elegant hotel comprises a modern tower, a 19th-century office block, and a 1932 bank building. It is conveniently located just an 8-minute walk from Cape Town train station.
...
Internet access
Electronic safe
Important information',true,'2026-07-07T08:37:13.224774+00:00','2026-07-07T08:46:01.9748+00:00','active',null,'the-centurion-hotel','4f4697f4-949f-4dad-85d8-7b4a5f07631a',0,'1001 Lenchen Ave N, Centurion Central, Centurion, 0046','Discover a place where you truly belong. At The Centurion Hotel, comfort and convenience combine to create a welcoming retreat for both business and leisure travelers. Enjoy tasteful decor and cozy surroundings that make you feel at home. With every detail designed for your comfort, The Centurion Hotel is the perfect choice for your next stay, offering heartfelt hospitality and a relaxing atmosphere to help you recharge and connect.','14:00:00','10:00:00',null,2,12,ARRAY[]::text[],ARRAY[]::text[]),
...
-- tag columns null, so they upsert the one untagged row per key and never touch
-- the per-supplier or per-kind variants. The unify-email-templates migration
...
on conflict (key, supplier_id, supplier_kind) do update set subject=excluded.subject,
...
-- ============================================================
-- Intentionally empty: the SUPPLIERS insert above now writes street_address directly. Formerly
-- mirrored migration 20260810160000's location_detail -> street_address backfill for rows this
-- seed recreates from scratch on every db:reset; that copy is redundant now that location_detail
-- is gone (see 20260817160000_supplier_single_location.sql).
