...
export const templates: Template[] = [
  { id: "t1", key: "quote_email", subject: "Your Rovos Rail Quote - {{jobNumber}}", bodyHtml: "<p>Dear {{customerName}},</p><p>Thank you for your enquiry regarding Rovos Rail. Please find attached your personalised quotation for the <strong>{{direction}}</strong> journey departing on <strong>{{departureDate}}</strong>.</p><p>This quote is valid until <strong>{{validityDate}}</strong>.</p><p>Total: <strong>R{{total}}</strong></p><p>Should you wish to proceed, please confirm your acceptance and we will arrange the deposit invoice.</p><p>Kind regards,<br/>Luxus Travel & Tours</p>", version: 2, active: true, isSystem: true },
  ...
  { id: "t4", key: "voucher_email", subject: "Your Travel Voucher - {{jobNumber}}", bodyHtml: "<p>Dear {{customerName}},</p><p>Please find attached your travel voucher for the <strong>{{direction}}</strong> Rovos Rail journey.</p><p>Departure: <strong>{{departureDate}}</strong></p><p>Please ensure all travellers have their documentation ready. We wish you a wonderful journey!</p><p>Kind regards,<br/>Luxus Travel & Tours</p>", version: 1, active: true, isSystem: true },
]
