...
export const templates: Template[] = [
  { id: "t1", key: "quote_email", subject: "Your Quote - {{jobNumber}}", bodyHtml: "<p>Dear {{customerName}},</p><p>Thank you for your enquiry. Please find attached your personalised quotation for the <strong>{{direction}}</strong> journey departing on <strong>{{departureDate}}</strong>.</p><p>This quote is valid until <strong>{{validityDate}}</strong>.</p><p>Total: <strong>R{{total}}</strong></p><p>Should you wish to proceed, please confirm your acceptance and we will arrange the deposit invoice.</p><p>Kind regards,<br/>Luxus Travel & Tours</p>", version: 2, active: true, isSystem: true },
  { id: "t2", key: "follow_up", subject: "Following up on your enquiry - {{jobNumber}}", bodyHtml: "<p>Dear {{customerName}},</p><p>We trust this email finds you well. We are following up on the quotation sent on <strong>{{lastSentDate}}</strong> for your journey.</p><p>Please let us know if you have any questions or would like to make any changes to the itinerary.</p><p>We look forward to hearing from you.</p><p>Warm regards,<br/>Luxus Travel & Tours</p>", version: 1, active: true, isSystem: true },
  { id: "t3", key: "deposit_request", subject: "Deposit Request - {{jobNumber}}", bodyHtml: "<p>Dear {{customerName}},</p><p>Thank you for confirming your reservation. To secure your booking, a deposit of <strong>R{{depositAmount}}</strong> is required.</p><p>Banking details:</p><ul><li>Bank: First National Bank</li><li>Account: Luxus Travel & Tours</li><li>Account No: 62XXXXXXXX</li><li>Branch: 250655</li><li>Reference: {{jobNumber}}</li></ul><p>Kind regards,<br/>Luxus Travel & Tours</p>", version: 1, active: true, isSystem: true },
  { id: "t4", key: "voucher_email", subject: "Your Travel Voucher - {{jobNumber}}", bodyHtml: "<p>Dear {{customerName}},</p><p>Please find attached your travel voucher for the <strong>{{direction}}</strong> journey.</p><p>Departure: <strong>{{departureDate}}</strong></p><p>Please ensure all travellers have their documentation ready. We wish you a wonderful journey!</p><p>Kind regards,<br/>Luxus Travel & Tours</p>", version: 1, active: true, isSystem: true },
]
