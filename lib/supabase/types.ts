...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      booking_package_selection_units: {
        Row: {
          adult_count: number
        ...
        Relationships: [
          {
            foreignKeyName: "booking_package_selection_units_bathroom_type_id_fkey"
          ...
          {
            foreignKeyName: "booking_package_selection_units_bedroom_layout_id_fkey"
          ...
          {
            foreignKeyName: "booking_package_selection_units_bedroom_type_id_fkey"
          ...
          {
            foreignKeyName: "booking_package_selection_units_selection_id_fkey"
            columns: ["selection_id"]
            isOneToOne: false
            referencedRelation: "booking_package_selections"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "booking_package_selection_units_suite_type_id_fkey"
      ...
      booking_service_units: {
        ...
        Relationships: [
          {
            foreignKeyName: "booking_service_units_bathroom_type_id_fkey"
            columns: ["bathroom_type_id"]
            isOneToOne: false
            referencedRelation: "bathroom_types"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "booking_service_units_bedroom_layout_id_fkey"
            columns: ["bedroom_layout_id"]
            isOneToOne: false
            referencedRelation: "bedroom_layouts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "booking_service_units_bedroom_type_id_fkey"
            columns: ["bedroom_type_id"]
            isOneToOne: false
            referencedRelation: "bedroom_types"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "booking_service_units_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "booking_service_units_suite_type_id_fkey"
            columns: ["suite_type_id"]
            isOneToOne: false
            referencedRelation: "suite_types"
            referencedColumns: ["id"]
      ...
      booking_services: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "booking_services_rate_type_id_fkey"
            columns: ["rate_type_id"]
            isOneToOne: false
            referencedRelation: "rate_types"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "booking_services_route_id_fkey"
            columns: ["route_id"]
            isOneToOne: false
            referencedRelation: "routes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "booking_services_suite_type_id_fkey"
            columns: ["suite_type_id"]
            isOneToOne: false
            referencedRelation: "suite_types"
            referencedColumns: ["id"]
      ...
      booking_transport_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "booking_transport_requests_package_leg_id_fkey"
            columns: ["package_leg_id"]
            isOneToOne: false
            referencedRelation: "package_legs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "booking_transport_requests_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
            referencedRelation: "booking_services"
            referencedColumns: ["id"]
      ...
      bookings: {
        Row: {
          ...
          services_confirmed_by: string | null
    ...
    Enums: {
      ...
      service_origin: "auto" | "consultant"
      source_kind:
        | "web_form"
        | "paste_import"
        | "advertisement"
