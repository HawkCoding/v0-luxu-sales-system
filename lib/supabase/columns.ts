...
export const BOOKING_TRANSPORT_REQUEST_COLUMNS =
  "id, booking_id, supplier_id, route_id, suite_type_id, service_id, service_type, pickup_point, dropoff_point, pickup_at, passenger_count, luggage_count, flight_number, price_override, price_override_set_at, price_override_set_by, notes, sort_order, supplier_reference, supplier_contact_name, voucher_footnote, created_at, updated_at, rental_details:booking_vehicle_rental_details(transport_request_id, return_at, return_cutoff_time, created_at, updated_at)"
