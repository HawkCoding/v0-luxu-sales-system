...
export const TRAVELLER_COLUMNS =
  "id, booking_id, prefix, first_name, last_name, id_passport, date_of_birth, residence, room_with, room_type, is_child, is_primary, sort_order, club_memberships"
