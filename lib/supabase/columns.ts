...
export const BOOKING_TRANSPORT_REQUEST_COLUMNS =
  "id, booking_id, supplier_id, route_id, suite_type_id, package_leg_id, service_id, service_type, pickup_point, dropoff_point, pickup_at, passenger_count, luggage_count, flight_number, price_override, notes, sort_order, supplier_reference, created_at, updated_at, rental_details:booking_vehicle_rental_details(transport_request_id, return_at, return_cutoff_time, created_at, updated_at)"
...
export const QUOTE_COLUMNS =
  "id, booking_id, itinerary_id, status, quote_number, parent_quote_id, validity_until, subtotal, total, last_sent_at, override_pin, override_reason, created_at, updated_at"
