...
export const BOOKING_TRANSPORT_REQUEST_COLUMNS =
  "id, booking_id, supplier_id, route_id, suite_type_id, package_leg_id, service_type, pickup_point, dropoff_point, pickup_at, passenger_count, luggage_count, flight_number, notes, sort_order, created_at, updated_at, rental_details:booking_vehicle_rental_details(transport_request_id, return_at, return_cutoff_time, created_at, updated_at)"
