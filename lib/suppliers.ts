...
export function mapBookingTransportRequest(row: BookingTransportRequestWithRentalDetails): BookingTransportRequest {
  return {
    ...
    adultCount: row.adult_count ?? null,
    childCount: row.child_count ?? null,
    infantCount: row.infant_count ?? null,
    priceOverrideChild: row.price_override_child ?? null,
    priceOverrideInfant: row.price_override_infant ?? null,
